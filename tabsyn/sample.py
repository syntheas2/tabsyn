...
def main(args):
    ...
    train_z, pre_decoder, token_dim, num_inverse, cat_inverse, original_columns, column_metadata = get_input_generate(args)
    ...
    model.load_state_dict(torch.load(args.ckpt_path)['model_state_dict'])
