...
from pythelpers.ml.mlflow import load_latest_checkpoint_from_mlflow, rotate_checkpoints, remove_all_from_artifact_dir
...
def train_evaluate_vae(
    ...
    local_best_model_file = Path(f"./{config.best_vae_model_filename}_temp_best.pt")
