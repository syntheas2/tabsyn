...
class VAEArgs(BaseModel):
    ...
    num_epochs: int = 500 # Example: make this configurable, was 1 in snippet
    max_beta: float = 0.01
    min_beta: float = 1e-5
    ...
    load_ckp_from_run_id: str = "e422543b2b2d40ae8cb4c7987d92ffc7"
    load_from_checkpoint: bool = True
    max_checkpoints_to_keep: int = 5
    checkpoint_save_interval: int = 20

    # Filenames for artifacts (ZenML will place them in its store)
    best_vae_model_filename: str = "best_vae_model_state.pt"
    final_encoder_filename: str = "final_encoder_state.pt"
    final_decoder_filename: str = "final_decoder_state.pt"
    train_embeddings_filename: str = "train_z_embeddings.npy"